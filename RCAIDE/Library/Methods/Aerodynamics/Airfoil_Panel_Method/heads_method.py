    ...
    for case in range(ncases):
        for cpt in range(ncpts):  
            ...
            if l == 0.0:
                ...
                x_i, Theta, delta_star, H, cf, Re_theta, Re_x, delta = heads_loop(n, H, cf, H1, Theta, dx, x_i, VeThetaH1, Ve_i, dVe_i, nu)
...
@jit(nopython=True)
def heads_loop(n,H,cf,H1,Theta,dx,x_i,VeThetaH1,Ve_i,dVe_i,nu):
    for i in range(1,n):
        ...
        while abs(erH)>1E-6 or abs(erH1)>1E-6 or abs(erTheta)>1E-6 or abs(ercf)>1E-6:
    ...
    return x_i, Theta, delta_star, H, cf, Re_theta, Re_x, delta
